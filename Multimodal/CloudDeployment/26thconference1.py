...
#             messages=[
#                 {"role": "system", "content": """
#                     This is the first interaction of the assistant with a user at the AI Objectives Institute (AOI) conference. The assistant's primary objectives are:
#                     1. To warmly welcome the user to the conference.
#                     2. To check the user's input for their name and extract it. If the name is found, acknowledge it by including the name in the welcoming message, like 'Welcome [Name] to the AI Objectives Institute (AOI) conference. Please continue with the conversation.'
#                     3. If the name is not clearly provided in the input, the assistant should politely ask for the name by saying 'Welcome to the AI Objectives Institute (AOI) conference. Please tell me your name.'
...
#         else:
#             return "Welcome to the AI Objectives Institute (AOI) conference. Please tell me your name.", None
#     except Exception as e:
...
#             messages=[
#                 {"role": "system", "content": """
#                     Analyze the generated message carefully. Examine the generated message for a greeting that includes a participant's name. Extract only the name that appears immediately after 'Welcome' or 'Welcome to the conference,' as in the phrases 'Welcome [Name] to the AI Objectives Institute (AOI) conference' or 'Welcome to the AI Objectives Institute (AOI) conference, [Name].' Return strictly the name itself without any additional text. If the message prompts with 'Please tell me your name,' indicate that no name was provided by returning 'No name found'.
...
#             send_message(From, f"Welcome {extracted_name} to the AI Objectives Institute (AOI) conference. Please continue with the conversation. To change your name, type 'change name' followed by your new name.")
#         else:
...
#         if extracted_name and extracted_name != "No name found":
#             user_doc_ref.update({'name': extracted_name})
#             send_message(From, f"Welcome {extracted_name}! Please continue with the conversation. To change your name, type 'change name' followed by your new name.")
#         else:
...
## 24th June last touches before the event
