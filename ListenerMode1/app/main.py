...
from core.config import (
    db, logger, OPENAI_API_KEY, twilio_client, twilio_number,
    assistant_id, twilio_account_sid, twilio_auth_token
)

# Utility and Service Imports
from utils.message_generation import (
...
from services.firebase_service import initialize_firestore
from utils.input_validation import is_valid_name, is_valid_event_id
